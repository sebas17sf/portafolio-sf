export const ProductService = {
    getProductsData() {
        return [
            {
                id: '1001',
                code: 'laravel-basic-advanced',
                name: 'Curso de LARAVEL Básico - Avanzado',
                description: 'Aprende desde lo básico hasta lo avanzado en Laravel.',
                image: 'laravel.png',
                price: 0,
                category: 'Cursos',
                quantity: 0,
            ...
            {
                id: '1002',
                code: 'dotnet-core-medium',
                name: '.Net Core Medio',
                description: 'Curso intermedio de .Net Core para desarrollo de aplicaciones web y APIs.',
                image: 'dotnet-course.jpg',
                price: 0,
                category: 'Cursos',
                quantity: 0,
                inventoryStatus: 'OUTOFSTOCK',
            ...
            {
                id: '1003',
                code: 'java-spring-advanced',
                name: 'Java Spring Medio - Avanzado',
                description: 'Aprende a desarrollar aplicaciones con Java Spring en nivel intermedio y avanzado.',
                image: 'java-spring-course.jpg',
                price: 0,
                category: 'Cursos',
                quantity: 0,
                inventoryStatus: 'OUTOFSTOCK',
            ...
            },
            {
                ...
                code: 'python-medium',
                name: 'Python Medio',
                description: 'Curso de nivel medio en Python para desarrollo de aplicaciones y automatización.',
            ...
            {
                id: '1005',
                code: 'vue-basic-medium',
                name: 'Vue Básico - Medio',
                description: 'Aprende Vue.js desde lo básico hasta un nivel medio con ejemplos prácticos.',
                image: 'vue-course.jpg',
                price: 0,
                category: 'Cursos',
                quantity: 0,
                inventoryStatus: 'OUTOFSTOCK',
